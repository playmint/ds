    ...
    public List<Dictionary<string, BaseComponentData>> GetStates()
    {
        return new()
        {
            new()
            {
                ...
                { "Factory/7", new FactoryBuildingData() { q = -1, r = 0, s = 1, height = 0.01f, model = "03-01", rotation = -30, color = "0" } },
            ...
            new()
            {
                { "Tile/7", new TileData() { q = -1, r = 0, s = 1, height = 0f, color = "#506A95" } },
                { "BuilderCamera", new BuilderCameraData() { q = -1, r = 0, s = 1, height = 0.01f} },
                { "Factory/7", new FactoryBuildingData() { q = -1, r = 0, s = 1, height = 0.01f, model = "02-03", rotation = -30, color = "0" } },
                { "GroundPlane/1", new GroundPlaneData() { height = 0f, color = "#33486D" } },
            },
            new()
            {
                { "Tile/7", new TileData() { q = -1, r = 0, s = 1, height = 0f, color = "#506A95" } },
                { "BuilderCamera", new BuilderCameraData() { q = -1, r = 0, s = 1, height = 0.01f} },
                { "Factory/7", new FactoryBuildingData() { q = -1, r = 0, s = 1, height = 0.01f, model = "01-02", rotation = -30, color = "0" } },
                { "GroundPlane/1", new GroundPlaneData() { height = 0f, color = "#33486D" } },
            },
        };
    }
