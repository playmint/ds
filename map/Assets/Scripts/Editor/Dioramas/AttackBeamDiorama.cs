    ...
    public List<Dictionary<string, BaseComponentData>> GetStates()
    {
        return new()
        {
            new()
            {
                ...
                { "Tile/1", new TileData() { q = 0, r = 0, s = 0, height = 0.5f, color = "#506A95" } },
                ...
                { "Factory/1", new GeneratorBuildingData() { q = 0, r = 0, s = 0, height = 0.5f, rotation = -30, selected = "highlight", color = "0" } },
            },
            new()
            {
                ...
                { "Tile/7", new TileData() { q = -1, r = 0, s = 1, height = 0f, color = "#1980E0" } },
                { "Factory/1", new GeneratorBuildingData() { q = 0, r = 0, s = 0, height = 0.5f, rotation = -30, selected = "highlight", color = "0" } },
                { "Path/1", new AttackBeamData() { qFrom = 0, rFrom = 0, sFrom = 0, heightFrom = 0.5f, qTo = -1, rTo = 1, sTo = 0, heightTo = 0.01f } },
            },
            new()
            {
                ...
                { "Tile/7", new TileData() { q = -1, r = 0, s = 1, height = 0f, color = "#1980E0" } },
                { "Factory/1", new GeneratorBuildingData() { q = 0, r = 0, s = 0, height = 0.5f, rotation = -30, selected = "highlight", color = "0" } },
                { "Path/2", new AttackBeamData() { qFrom = 0, rFrom = 0, sFrom = 0, heightFrom = 0.5f, qTo = 0, rTo = 1, sTo = -1, heightTo = 0.01f } },
            },
            new()
            {
