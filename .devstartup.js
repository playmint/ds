...
const commands = [
    {
        name: 'networks',
        command: "anvil --block-base-fee-per-gas 1 -m 'thunder road vendor cradle rigid subway isolate ridge feel illegal whale lens' --code-size-limit 9999999999999  --block-time 2 --gas-limit 9999999999999999",
        prefixColor: 'black',
    },
