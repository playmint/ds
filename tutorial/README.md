...
|-------------|------------------------------------------------|-------------------|
| default     |<img src="images/map-default.png" width="100">  | A single tile map. Deploy this andhen use ds-cli to apply any other map |
| example-gate|<img src="images/map-gate.png" width="100">     | A map containing a Door and key demo |
...
| croissant   |<img src="images/map-croissant.png" width="100">| A Multi Game Map. This showcases multiple games on one map including Tonk Attack; Hexcraft; The Labyrinth and Ducks v Burgers. Tonk attack requires it's own services to be run, see below for details |
