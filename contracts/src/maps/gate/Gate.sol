...
contract ExampleGate is BuildingKind {
    function onUnitArrive(Game ds, bytes24 buildingInstanceID, bytes24 mobileUnitID) public override {
        ...
        // NOTE: There's a problem with generating the ID using Node.Item as it doesn't match the one generated by the cli tool.
        //       so hardcoding the ID until that problem is fixed
        bytes24 gateKey = 0x6a7a67f0d9cbd23100000001000000640000006400000064;
